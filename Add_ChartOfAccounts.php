<?php include($_SERVER['DOCUMENT_ROOT']."/includes/dcf_AddChartOfAccounts.php"); ?>
						...
						<form id="editCOAForm" name="editCOAForm">
							<table style="border-spacing: 40px 20px">
									...
									<td style="font-size: 28; color: #DD9787; padding-left: 50px">
										<div class="form-group">
											<select class="form-control" id="sel1">
											    ...
											    <?php echo "<option>" . $data["accountId"] . " - " . $data["accountName"] . "</option>"; ?>
												<?php } ?>
											</select>
										</div>
									</td>
								...
								<tr>
									...
									<td style="font-size: 28; color: #DD9787; padding-left: 50px">
										<input type="checkbox" name="addCOAActive">
									</td>
								</tr>
								<tr>
									...
									<td style="font-size: 28; color: #DD9787; padding-left: 50px; padding-top: 20px">
										<textarea id="addCOAComments" name="comments" class="form-control" rows="4" placeholder="Comments"></textarea>
									</td>
								</tr>
							</table>
						</form>	
