<?php 
	...
	//}
?>
<?php include ($_SERVER['DOCUMENT_ROOT']."/includes/dcf_Populate_ClosingJournalEntries.php") ?>
<html>
	<head>
		<title>Closing Journal</title>
		...
		<div class="container">
			<div class="row" style="margin-top: 40px">
				...
				<div class="row col-xs-10 col-sm-10 col-md-7 col-lg-7">
					<h1 style="color: #DD9787; border-bottom: 3px solid #A6C48A;">CLOSING JOURNAL ENTRIES</h1>
				</div>
